...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Cargar publicaciones e interactivos
    Promise.all([
        fetch('../posts.json').then(r => r.json()).catch(() => []),
        fetch('../js/interactivos-all.js').then(() => {
            // Los interactivos están en el archivo, los cargamos manualmente
            return [
                {
